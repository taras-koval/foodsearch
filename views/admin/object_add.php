				...
				<div class="content-body">
					...
					<div class="row">	
						...
						<form action="/admin/object/add/" method="post" 
							class="column-half admin-form" autocomplete="off" enctype="multipart/form-data">
							...
							<textarea name="description" id="object_description" rows="8"><?php echo $form['description'] ?></textarea>

							<!-- Photo -->
							<label for="object_photo">Фото <span>(Не обов'язково)</span></label>
